...
module.exports = {
	movie: {
		...
		image: movie,
		link: 'http://chuckreynolds.altervista.org/movie/index.html'
	},
	dungeon: {
		...
		image: dungeon,
		link: 'http://chuckreynolds.altervista.org/dungeon/index.html'
	},
	rect: {
	...
	gameoflife: {
		...
		tools: ['HTML/CSS', 'React', 'Redux'],
		image: gameoflife,
		link: 'http://chuckreynolds.altervista.org/gameoflife/index.html'
	},
	wiki: {
		title: 'Wiki Search',
		info:
		...
		image: wiki,
		link: 'http://chuckreynolds.altervista.org/wiki/index.html'
	},
	weather: {
		title: 'Local Weather',
		info:
		...
		image: weather,
		link: 'http://chuckreynolds.altervista.org/weather/index.html'
	},
	twitch: {
		...
		image: twitch,
		link: 'http://chuckreynolds.altervista.org/twitch/index.html'
	},
	leaderboard: {
		...
		image: leaderboard,
		link: 'http://chuckreynolds.altervista.org/leaderboard/index.html'
	},
	gdp: {
		...
		image: gdp,
		link: 'http://chuckreynolds.altervista.org/gdp/index.html'
	},
	heatmap: {
		...
		tools: ['HTML/CSS', 'Javascript', 'D3.js'],
		image: heatmap,
		link: 'http://chuckreynolds.altervista.org/heatmap/index.html'
	},
	force: {
		...
		tools: ['HTML/CSS', 'Javascript', 'D3.js'],
		image: force,
		link: 'http://chuckreynolds.altervista.org/force/index.html'
	},
	scatterplot: {
		...
		tools: ['HTML/CSS', 'Javascript', 'D3.js'],
		image: scatterplot,
		link: 'http://chuckreynolds.altervista.org/scatterplot/index.html'
	},
	games: {
		title: 'Game Search',
		info:
